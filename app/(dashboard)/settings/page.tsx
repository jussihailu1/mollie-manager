...
export default async function SettingsPage({
  ...
  const mollieConnection = await getTenantMollieConnection(tenantId);
  const mollieProfiles = mollieConnection?.status === "incomplete"
    ? await listTenantMollieProfiles(tenantId).catch(() => [])
    : [];
